...
public class SavedGameGeneralPanel extends JPanel {
    ...
    public SavedGameGeneralPanel(FTLFrame frame) {
        ...
        sessionPanel.getInt(TOP_BETA).setDocument(new RegexDocument());
        ...
        envPanel.getInt(ENV_ASTEROID_ALPHA).setDocument(new RegexDocument());
        envPanel.addRow(ENV_ASTEROID_STRAY_TICKS, FieldEditorPanel.ContentType.INTEGER);
        envPanel.getInt(ENV_ASTEROID_STRAY_TICKS).setDocument(new RegexDocument());
        envPanel.addRow(ENV_ASTEROID_GAMMA, FieldEditorPanel.ContentType.INTEGER);
        envPanel.getInt(ENV_ASTEROID_GAMMA).setDocument(new RegexDocument());
        envPanel.addRow(ENV_ASTEROID_BKG_TICKS, FieldEditorPanel.ContentType.INTEGER);
        envPanel.getInt(ENV_ASTEROID_BKG_TICKS).setDocument(new RegexDocument());
        envPanel.addRow(ENV_ASTEROID_TARGET, FieldEditorPanel.ContentType.INTEGER);
        envPanel.getInt(ENV_ASTEROID_TARGET).setDocument(new RegexDocument());
        envPanel.addBlankRow();
        envPanel.addRow(ENV_FLARE_FADE_TICKS, FieldEditorPanel.ContentType.INTEGER);
        envPanel.getInt(ENV_FLARE_FADE_TICKS).setDocument(new RegexDocument());
        envPanel.addRow(ENV_HAVOC_TICKS, FieldEditorPanel.ContentType.INTEGER);
        envPanel.getInt(ENV_HAVOC_TICKS).setDocument(new RegexDocument());
        envPanel.addRow(ENV_PDS_TICKS, FieldEditorPanel.ContentType.INTEGER);
        envPanel.getInt(ENV_PDS_TICKS).setDocument(new RegexDocument());
        envPanel.addBlankRow();
        envPanel.addFillRow();
        ...
        aiPanel.getInt(AI_SURRENDER_THRESHOLD).setDocument(new RegexDocument());
        aiPanel.addRow(AI_ESCAPE_THRESHOLD, FieldEditorPanel.ContentType.INTEGER);
        aiPanel.getInt(AI_ESCAPE_THRESHOLD).setDocument(new RegexDocument());
        ...
        unknownsPanel.getInt(TOP_WAIT_EVENT_SEED).setDocument(new RegexDocument());
        ...
        unknownsPanel.getInt(TOP_MU).setDocument(new RegexDocument());
        unknownsPanel.addBlankRow();
        unknownsPanel.addRow(TOP_NU, FieldEditorPanel.ContentType.INTEGER);
        unknownsPanel.getInt(TOP_NU).setDocument(new RegexDocument());
        unknownsPanel.addRow(TOP_XI, FieldEditorPanel.ContentType.INTEGER);
        unknownsPanel.getInt(TOP_XI).setDocument(new RegexDocument());
        ...
        encPanel.getInt(ENC_ALPHA).setDocument(new RegexDocument());
        ...
        encPanel.getInt(ENC_CREW_SEED).setDocument(new RegexDocument());
