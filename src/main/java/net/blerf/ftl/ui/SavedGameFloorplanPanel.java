    ...
    private void showRoomEditor(final ShipBundle shipBundle, final SpriteReference<RoomState> roomRef, final int squareId) {
        ...
        final Runnable applyCallback = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    roomRef.get().getSquare(squareId).setExtinguishmentProgress(editorPanel.parseInt(EXTINGUISHMENT));
                } catch (NumberFormatException e) {
                }
    ...
    private void showCrewEditor(final ShipBundle shipBundle, final SpriteReference<CrewState> crewRef) {
        ...
        final Runnable applyCallback = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    crewRef.get().setHealth(editorPanel.parseInt(HEALTH));
                } catch (NumberFormatException e) {
                }
                ...
                try {
                    crewRef.get().setRepairs(editorPanel.parseInt(REPAIRS));
                } catch (NumberFormatException e) {
                }

                try {
                    crewRef.get().setCombatKills(editorPanel.parseInt(COMBAT_KILLS));
                } catch (NumberFormatException e) {
                }

                try {
                    crewRef.get().setPilotedEvasions(editorPanel.parseInt(PILOTED_EVASIONS));
                } catch (NumberFormatException e) {
                }

                try {
                    crewRef.get().setJumpsSurvived(editorPanel.parseInt(JUMPS_SURVIVED));
                } catch (NumberFormatException e) {
                }

                try {
                    crewRef.get().setSkillMasteriesEarned(editorPanel.parseInt(SKILL_MASTERIES));
                } catch (NumberFormatException e) {
                }
                ...
                try {
                    crewRef.get().setCloneReady(editorPanel.parseInt(CLONE_READY));
                } catch (NumberFormatException e) {
                }
                ...
                try {
                    crewRef.get().setStunTicks(editorPanel.parseInt(STUN_TICKS));
                } catch (NumberFormatException e) {
                }

                try {
                    crewRef.get().setHealthBoost(editorPanel.parseInt(HEALTH_BOOST));
                } catch (NumberFormatException e) {
                }

                try {
                    crewRef.get().setClonebayPriority(editorPanel.parseInt(CLONEBAY_PRIORITY));
                } catch (NumberFormatException e) {
                }

                try {
                    crewRef.get().setDamageBoost(editorPanel.parseInt(DAMAGE_BOOST));
                } catch (NumberFormatException e) {
                }

                try {
                    crewRef.get().setUnknownLambda(editorPanel.parseInt(LAMBDA));
                } catch (NumberFormatException e) {
                }

                // TODO: Synchronize universal death count across all CrewStates on both ships.
                try {
                    crewRef.get().setUniversalDeathCount(editorPanel.parseInt(UNIV_DEATH_COUNT));
                } catch (NumberFormatException e) {
                }
                ...
                try {
                    crewRef.get().setLockdownRechargeTicks(editorPanel.parseInt(LOCKDOWN_RECHARGE_TICKS));
                } catch (NumberFormatException e) {
                }

                try {
                    crewRef.get().setLockdownRechargeTicksGoal(editorPanel.parseInt(LOCKDOWN_RECHARGE_GOAL));
                } catch (NumberFormatException e) {
                }

                try {
                    crewRef.get().setUnknownOmega(editorPanel.parseInt(OMEGA));
                } catch (NumberFormatException e) {
                }
