...
public class SavedGameSectorMapPanel extends JPanel {
    ...
    private void showGeneralEditor() {
        ...
        final Runnable applyCallback = new Runnable() {
            ...
            public void run() {
                try {
                    rebelFleetOffset = editorPanel.parseInt(REBEL_FLEET_OFFSET);
                } catch (NumberFormatException e) {
                }

                try {
                    rebelFleetFudge = editorPanel.parseInt(REBEL_FLEET_FUDGE);
                } catch (NumberFormatException e) {
                }

                try {
                    rebelPursuitMod = editorPanel.parseInt(REBEL_PURSUIT_MOD);
                } catch (NumberFormatException e) {
                }
        ...
        final Runnable applyCallback = new Runnable() {
            ...
            public void run() {
                ...
                if (flagshipVisible) {
                    ...
                    try {
                        flagshipBaseTurns = editorPanel.parseInt(FLAGSHIP_BASE_TURNS);
                    } catch (NumberFormatException e) {
                    }
                } else {
                    flagshipHop = 0;
                ...
                if (flagship != null) {
                    try {
                        flagship.setUnknownAlpha(editorPanel.parseInt(FLAGSHIP_ALPHA));
                    } catch (NumberFormatException e) {
                    }

                    try {
                        flagship.setUnknownGamma(editorPanel.parseInt(FLAGSHIP_GAMMA));
                    } catch (NumberFormatException e) {
                    }

                    try {
                        flagship.setUnknownDelta(editorPanel.parseInt(FLAGSHIP_DELTA));
                    } catch (NumberFormatException e) {
                    }
                }
    ...
    private void showBeaconEditor(final SpriteReference<BeaconState> beaconRef) {
        ...
        final Runnable applyCallback = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    bgSpritePosX = editorPanel.parseInt(SPRITE_X);
                } catch (NumberFormatException e) {
                }

                try {
                    bgSpritePosY = editorPanel.parseInt(SPRITE_Y);
                } catch (NumberFormatException e) {
                }

                try {
                    bgSpriteRotation = editorPanel.parseInt(SPRITE_ROT);
                } catch (NumberFormatException e) {
                }
                ...
                try {
                    shipEventSeed = Integer.parseInt(newString);
                } catch (NumberFormatException e) {
                }
    ...
    private void showStoreEditor(final SpriteReference<BeaconState> beaconRef) {
        ...
        final Runnable applyCallback = new Runnable() {
            ...
            public void run() {
                try {
                    beaconRef.get().getStore().setFuel(editorPanel.parseInt(FUEL));
                } catch (NumberFormatException e) {
                }

                try {
                    beaconRef.get().getStore().setMissiles(editorPanel.parseInt(MISSILES));
                } catch (NumberFormatException e) {
                }

                try {
                    beaconRef.get().getStore().setDroneParts(editorPanel.parseInt(DRONE_PARTS));
                } catch (NumberFormatException e) {
                }
    ...
    public class QuestSprite extends MapBoxComponent {
        ...
        public void setQuestId(String s) {
            questId = s;
        }
