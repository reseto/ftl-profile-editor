...
public class Score implements Comparable<Score> {
	...
	public String toString() {
		return String.format("Name: %-25s  ShipId: %-25s  Score: %5d%n", shipName, shipId, value) +
				String.format("Sector: %d  Difficulty: %-6s  Victory: %-5b  DLC Enabled: %-5b%n", sector, difficulty.toString(), victory, dlcEnabled);
	}
}
